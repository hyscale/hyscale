...
docker build --pull -t gcr.io/hyscale-dev-env/hyscale/hyscale:${Hyscale_Docker_Image_Tag}.$BUILD_NUMBER .
docker rmi -f gcr.io/hyscale-dev-env/hyscale/hyscale:${Hyscale_Docker_Image_Tag}.$BUILD_NUMBER
