...
public enum ManifestGeneratorActivity implements Activity {
    ...
    FAILED_TO_CREATE_IMAGE_PULL_SECRET("Missing pull credentials for the registry {}. In case of deployment failure perform 'docker login {} ' to continue with the deployment");
