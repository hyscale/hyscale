...
@Component
public class FixHealthCheckAction implements Node<TroubleshootingContext> {

    @Override
    public Node<TroubleshootingContext> next(TroubleshootingContext context) throws HyscaleException {
        WorkflowLogger.debug(ActionMessage.LIVENESS_PROBE_FAILURE,context.getServiceInfo().getServiceName());
        return null;
    }
