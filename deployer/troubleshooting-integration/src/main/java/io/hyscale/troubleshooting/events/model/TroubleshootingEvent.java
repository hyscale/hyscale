 ...
 */
package io.hyscale.troubleshooting.events.model;
...
public class TroubleshootingEvent extends ActivityEvent {
    private List<DiagnosisReport> diagnosisReports;

    public TroubleshootingEvent(ActivityState state) {
        super(state);
    }

    public TroubleshootingEvent(ActivityState state, List<DiagnosisReport> diagnosisReports) {
        super(state);
