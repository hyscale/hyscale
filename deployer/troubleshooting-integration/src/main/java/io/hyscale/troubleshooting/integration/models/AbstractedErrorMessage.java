...
public enum AbstractedErrorMessage implements IMessage, IReason {
    ...
    FIX_IMAGE_NAME("Invalid Image name or tag provided in hspec.", "Recheck the image name or tag  in hpsec."),
    ...
    INVALID_VOLUME_NAME("Volume name provided in service spec is invalid.", "Volume name must be less than 63 characters and follow the regex [a-z0-9][a-z0-9.-]."),
