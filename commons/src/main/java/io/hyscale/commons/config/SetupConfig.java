...
public class SetupConfig {
    ...
    public static String getToolLogDir() {
        return INSTALLATION_DIR + FILE_SEPARATOR + HYSCALE + FILE_SEPARATOR + LOG_DIR;
    }
    ...
    public String getAppsDir() {
        return getInstallationDir() + HYSCALE + FILE_SEPARATOR + APPS_DIR + FILE_SEPARATOR;
    }
    ...
    public String getLogsDir(String appName, String serviceName) {
        return getServiceDir(appName, serviceName) + LOG_DIR + FILE_SEPARATOR;
    }
