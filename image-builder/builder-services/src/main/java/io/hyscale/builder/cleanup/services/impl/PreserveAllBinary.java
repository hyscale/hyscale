...
/**
 * Class provides a docker binary based implementation of {@link PreserveAll}
 */
@Component
@Conditional(DockerBinaryCondition.class)
public class PreserveAllBinary extends PreserveAll {

    private static final Logger logger = LoggerFactory.getLogger(PreserveAllBinary.class);
